...
/*		W = new Element("div", {
		...
		mediabox : function(X, aa, Z) {
			...
			Y.removeEvents("click").addEvent(
					...
					function() {
						...
						return Mediabox.open(ad.map(aa), ab.indexOf(this
								.toString()), X)
					});
			return Y
		}
	...
	function a(X) {
		if (X >= 0) {
			...
			G = Q.length;
			if (G > 1) {
				B = (Q[G - 2].match("%")) ? (window.getWidth() * ((Q[G - 2]
						.replace("%", "")) * 0.01))
						+ "px" : Q[G - 2] + "px";
				o = (Q[G - 1].match("%")) ? (window.getHeight() * ((Q[G - 1]
						.replace("%", "")) * 0.01))
						+ "px" : Q[G - 1] + "px"
			} else {
				B = "";
			...
			if (D.match(/\.gif|\.jpg|\.jpeg|\.png|twitpic\.com/i)
					|| i == "image") {
				i = "img";
				...
				if (D.match(/\.flv|\.mp4/i) || i == "video") {
					...
					if (A.useNB) {
						t = new Swiff(
								""
										...
										+ "?mediaURL="
										+ D
										+ "&allowSmoothing=true&autoPlay="
										+ A.autoplay
										+ "&buffer=6&showTimecode="
										+ A.showTimecode
										+ "&loop="
										+ A.medialoop
										+ "&controlColor="
						...
						t = new Swiff("" + A.JWplayerpath + "?file=" + D
								+ "&backcolor=" + A.backcolor + "&frontcolor="
								+ A.frontcolor + "&lightcolor=" + A.lightcolor
								+ "&screencolor=" + A.screencolor
								+ "&autostart=" + A.autoplay + "&controlbar="
								+ A.controlbar, {
							id : "MediaboxSWF",
							width : B,
							height : o,
					...
					if (D.match(/\.mp3|\.aac|tweetmic\.com|tmic\.fm/i)
							|| i == "audio") {
						var Y = new URI(D);
						D = "../../" + Y.toRelative();
						i = "obj";
						...
						if (D.match(/tweetmic\.com|tmic\.fm/i)) {
							D = D.split("/");
							D[4] = D[4] || D[3];
							D = "http://media4.fjarnet.net/tweet/tweetmicapp-"
									+ D[4] + ".mp3"
						}
						if (A.useNB) {
							t = new Swiff(
						...
						if (D.match(/\.swf/i) || i == "flash") {
							...
							if (D
									.match(/\.mov|\.m4v|\.m4a|\.aiff|\.avi|\.caf|\.dv|\.mid|\.m3u|\.mp3|\.mp2|\.mp4|\.qtz/i)
									|| i == "qt") {
								i = "qt";
								B = B || A.defaultWidth;
								o = (parseInt(o) + 16) + "px"
										...
										if (D.match(/dailymotion\.com/i)) {
											...
											if (D.match(/facebook\.com/i)) {
												...
												if (D.match(/flickr\.com/i)) {
													...
													d = f[5];
													t = new Swiff(
															"http://www.flickr.com/apps/video/stewart.swf",
															{
																id : d,
																classid : "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",
																width : B,
													...
													if (D
														...
														if (D
															...
															if (D
																...
																d = f[1];
																t = new Swiff(
																		"http://wwwstatic.megavideo.com/mv_player.swf?v="
																				+ d,
																		{
																			id : d,
																			width : B,
																		...
																		if (D
																			...
																			if (D
																				...
																				if (D
																					...
																					d = f[5];
																					t = new Swiff(
																							"http://seesmic.com/Standalone.swf?video="
																									+ d,
																							{
																								id : d,
																								width : B,
																					...
																					if (D
																						...
																						if (D
																							...
																							d = f[3];
																							t = new Swiff(
																									"http://static.livestream.com/chromelessPlayer/wrappers/TwitcamPlayer.swf?hash="
																											+ d,
																									{
																										width : B,
																										height : o,
																										...
																										if (D
																											...
																											if (D
																												...
																												if (D
																													...
																													d = f[1];
																													t = new Swiff(
																															"http://www.veoh.com/static/swf/webplayer/WebPlayer.swf?version=AFrontend.5.5.2.1001&permalinkId="
																																	+ d
																																	+ "&player=videodetailsembedded&videoAutoPlay="
																																	+ A.AutoplayNum
																																	+ "&id=anonymous",
																															{
																																id : d,
																													...
																													if (D
																														...
																														if (D
																															...
																															t = new Swiff(
																																	...
																																	{
																																		id : d,
																																		movie : "http://www.viddyou.com/get/v2_"
																																				+ A.vuPlayer
																																				+ "/"
																																				+ d
																																				+ ".swf",
																															...
																															if (D
																																...
																																t = new Swiff(
																																		"http://www.vimeo.com/moogaloop.swf?clip_id="
																																				+ d
																																				+ "&amp;server=www.vimeo.com&amp;fullscreen="
																																				+ A.fullscreenNum
																																				+ "&amp;autoplay="
																																				+ A.autoplayNum
																																				+ "&amp;show_title="
	...
	function p() {
			...
			if (i == "obj") {
				if (Browser.Plugins.Flash.version < 8) {
					...
					j
							.set(
									"html",
									'<div id="mbError"><b>Error</b><br/>Adobe Flash is either not installed or not up to date, please visit <a href="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" title="Get Flash" target="_new">Adobe.com</a> to download the free player.</div>');
					B = A.DefaultWidth;
					o = A.DefaultHeight
				} else {
					j.setStyles({
					...
					if (i == "inline") {
						...
						if (i == "url") {
							...
							j
									.set(
											"html",
											'<div id="mbError"><b>Error</b><br/>A file type error has occoured, please visit <a href="iaian7.com/webcode/mediaboxAdvanced" title="mediaboxAdvanced" target="_new">iaian7.com</a> or contact the website author for more information.</div>');
							B = A.defaultWidth;
							o = A.defaultHeight
						}
					}
		...
		/*W.set("html", (A.showCounter && (h.length > 1)) ? A.counterText
				.replace(/{x}/, P + 1).replace(/{y}/, h.length) : "");*/
		if ((H >= 0)
				&& (h[H][0].match(/\.gif|\.jpg|\.jpeg|\.png|twitpic\.com/i))) {
			z.src = h[H][0].replace(/twitpic\.com/i, "twitpic.com/show/full")
		}
		if ((O >= 0)
				&& (h[O][0].match(/\.gif|\.jpg|\.jpeg|\.png|twitpic\.com/i))) {
